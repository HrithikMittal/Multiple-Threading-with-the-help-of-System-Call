...
int main()
{
   ...
   if(pthread_create(&thrd1,NULL,thrd1_f1,(void *) &n)<0)
   {
      perror("Pthread_create");
      exit(1);
   }

if(pthread_create(&thrd2,NULL,thrd2_f2,(void *) &n)<0)
   {
      perror("Pthread_create");
      exit(1);
   }
